...
<div class="container">
  <div class="title">Medical Insurance</div>
  <form action="AddRecordServ" enctype="multipart/form-data" method="post">
    <div class="user__details">
    
    <div class="input__box">
        <span class="details">Medical Insurance Doc</span>
        <input type="file" placeholder="" name="inputdisimg" required>
      </div>
    
      <div class="input__box">
        <span class="details">title</span>
        <input type="text" placeholder="Title" name="title" value="Medical Insurance" disabled required>
      </div>
      <div class="input__box">
