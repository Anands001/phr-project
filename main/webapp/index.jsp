...
<body>
  ...
  <main id="main">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-7 col-lg-5">
            <div class="about-content" data-aos="fade-left" data-aos-delay="100">
              ...
              <h2><span>eHealth</span>Easy to use</h2>
              <p>eHealth is a free tool that manages personal and family health records by using an easy-to-use iPad app and mobile website to track, collect and safely disseminate healthcare information. Your data is duplicated and stored on eHealth secure cloud server--making it accessible 24/7 from multiple devices, anywhere in the world.</p>

              <ul class="list-unstyled">
                <li><i class="vi bi-chevron-right"></i>CareOne</li>
                <li><i class="vi bi-chevron-right"></i>Patient Portal</li>
                <li><i class="vi bi-chevron-right"></i>Easy to Use</li>
                <li><i class="vi bi-chevron-right"></i>Unlimited Features</li>
                <li><i class="vi bi-chevron-right"></i>MyNotes</li>
              </ul>
    ...
    <section id="contact" class="padd-section">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title text-center">
          <h2>Contact</h2>
          <p class="separator">We want to hear from you!
            Thank you for using or learning more about eHealth. Let us know if you have:    
          <p>Ideas for Healthspek
            What you like
            What you don’t like
            Questions
            General comments
            And someone from our team will be in touch with you soon!
          </p>
          </p>
        </div>
          ...
          <div class="col-lg-3 col-md-4">
            ...
            <div class="info">
              <div>
                ...
                <p>T Nagar, 3rd Main Road<br>Chennai, India</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <p>ehealth@yahoo.com</p>
              </div>
  ...
  <!-- ======= Footer ======= -->
    <div class="copyrights">
      <div class="container">
        <p>&copy; Copyrights eHealth. All rights reserved.</p>
        <div class="credits">
        </div>
      </div>
    </div>
